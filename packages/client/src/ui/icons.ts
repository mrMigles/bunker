...
const P: Record<string, string> = {
  ...
  hammer: '<path d="M4 20l8.5-8.5"/><rect x="10.5" y="4.5" width="11" height="5.5" rx="1" transform="rotate(45 16 7.25)"/>',
  wrench: '<path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.5 2.5-2.4-.6-.6-2.4z"/>',
  box: '<path d="M21 8 12 3 3 8v8l9 5 9-5z"/><path d="m3 8 9 5 9-5M12 13v8"/>',
  backpack: '<path d="M5 10a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v10a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1z"/><path d="M9 5V3h6v2"/><rect x="8" y="13" width="8" height="5" rx="1"/>',
  ...
  shovel: '<path d="M4 20l7-7"/><path d="M12.5 11.5 10 9l5-5 5 5-5 5z"/>',
  ...
  muscle: '<path d="M6.5 6v12M17.5 6v12M3.5 9v6M20.5 9v6M6.5 12h11"/>',
